...
export const config = {
  ...
  redis: {
    ...
    monitoring: {
      ...
      latencyWarningThreshold: parseInt(process.env.REDIS_LATENCY_WARNING || '100'), // 100ms
      latencyCriticalThreshold: parseInt(process.env.REDIS_LATENCY_CRITICAL || '500'), // 500ms
    },
